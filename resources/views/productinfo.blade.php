                ...
                <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                    <div class="product-image">
                        ...
                        <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                            @foreach ($productsinfo['otherImage'] as $items)
                            {{ $oimag = '/products/other/' . $items->img_name }}
                            <div class="item">
                                <a href="#" class="product_gallery_item active" data-image={{ asset($oimag) }} data-zoom-image={{ asset($oimag) }}>
                                    <img src={{ asset($oimag) }} alt={{ $items->img_name }} />
                                </a>
                            </div>
                            @endforeach

                            ...
                            <div class="about">
                                <div class="about__container">
                                    <div class="about__info">
                                        <h2 class="about__h2">Welcome to IT STORE</h2>
                                        <div class="about__p-wrap">
                                            <p class="about__p">Lorem Ipsum is simply dummy text of the printing and
                                        ...
                                        <a class="about__link btn--e-secondary" href="product">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="team-member u-h-100">
                                <div class="team-member__wrap">
                                    <div class="aspect aspect--bg-grey-fb aspect--square">
                                        ...
                                        <img class="aspect__img team-member__img" src="assets/images/about/member-1.jpg"
                                            alt="">
                                    </div>
                            ...
                            <div class="team-member u-h-100">
                                <div class="team-member__wrap">
                                    <div class="aspect aspect--bg-grey-fb aspect--square">
                                        ...
                                        <img class="aspect__img team-member__img" src="assets/images/about/member-2.jpg"
                                            alt="">
                                    </div>
                                    <div class="team-member__social-wrap">
                                        <ul class="team-member__social-list">
                            ...
                            <div class="team-member u-h-100">
                                <div class="team-member__wrap">
                                    <div class="aspect aspect--bg-grey-fb aspect--square">
                                        ...
                                        <img class="aspect__img team-member__img" src="assets/images/about/member-3.jpg"
                                            alt="">
                                    </div>
                                    <div class="team-member__social-wrap">
                                        <ul class="team-member__social-list">
                            ...
                            <div class="team-member u-h-100">
                                <div class="team-member__wrap">
                                    <div class="aspect aspect--bg-grey-fb aspect--square">
                                        ...
                                        <img class="aspect__img team-member__img" src="assets/images/about/member-4.jpg"
                                            alt="">
                                    </div>
                                    <div class="team-member__social-wrap">
                                        <ul class="team-member__social-list">

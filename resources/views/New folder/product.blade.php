                                                ...
                                                @foreach ($category['main'] as $items)
                                                    <li class="has-list">
                                                        ...
                                                        <a style="text-transform:uppercase;"
                                                            href="maincategory/{{ $items->catid }}">{{ $items->name }}</a>

                                                        <span class="js-shop-category-span  fas fa-plus u-s-m-l-6">
                                                        </span>
                                                        <ul style="display:none">
                                                            @foreach ($category['sub'] as $subitems)
                                                                @if ($items->catid == $subitems->catid)
                                                                    <li>
                                                                        <a
                                                                            href="/subcategory/{{ $subitems->subid }}">{{ $subitems->name }}</a>
                                                                    </li>
                                                                @endif
                                                            @endforeach
                                                        </ul>
                                            ...
                                            <div class="product-m">
                                                <div class="product-m__thumb">
                                                    ...
                                                    <div class="product-m__add-cart">
                                                        <a href="/addcart/{{$items->pid}}" class="btn--e-brand" >Add to Cart</a>
                                                    </div>
